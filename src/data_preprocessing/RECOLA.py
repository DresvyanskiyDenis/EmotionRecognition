...
def main():
    path_to_data = r"G:\Datasets\RECOLA\original\RECOLA_Video_recordings"
    output_path = r"G:\Datasets\RECOLA\preprocessed"
    path_to_arousal_labels = r"G:\Datasets\RECOLA\REC_labels_arousal_100Hz_gold_shifted.csv"
    path_to_valence_labels = r"G:\Datasets\RECOLA\REC_labels_valence_100Hz_gold_shifted.csv"
    ...
    # save metadata
    metadata.to_csv(os.path.join(r"G:\Datasets\RECOLA", "preprocessed_labels.csv"), index=False)
