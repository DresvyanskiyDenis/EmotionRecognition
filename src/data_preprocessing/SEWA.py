...
def main():
    ...
    path_to_data = r"G:\Datasets\SEWA\Original\videos"
    output_path = r"G:\Datasets\SEWA\preprocessed"
    path_to_arousal_labels = r"G:\Datasets\SEWA\SEW_labels_arousal_100Hz_gold_shifted.csv"
    path_to_valence_labels = r"G:\Datasets\SEWA\SEW_labels_valence_100Hz_gold_shifted.csv"
    ...
    # save metadata
    metadata.to_csv(os.path.join(r"G:\Datasets\SEWA", "preprocessed_labels.csv"), index=False)
