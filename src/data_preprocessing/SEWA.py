...
def main():
    ...
    path_to_data = "/media/external_hdd_1/Datasets/SEWA/Original/videos"
    output_path = "/media/external_hdd_1/Datasets/SEWA/preprocessed"
    path_to_arousal_labels = "/media/external_hdd_1/Datasets/SEWA/SEW_labels_arousal_100Hz_gold_shifted.csv"
    path_to_valence_labels = "/media/external_hdd_1/Datasets/SEWA/SEW_labels_valence_100Hz_gold_shifted.csv"
    ...
    # save metadata
    metadata.to_csv(os.path.join("/media/external_hdd_1/Datasets/SEWA/preprocessed", "preprocessed_labels.csv"), index=False)
