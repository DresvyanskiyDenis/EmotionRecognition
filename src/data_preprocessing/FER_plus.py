...
def main():
    ...
    # preprocess images (extract faces). I have decided to not do it, since the face detector for some reason
    # does not find faces in a lot of images. Possible reasons are that they are grey-scale and low resolution
