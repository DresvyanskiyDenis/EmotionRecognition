...
from src.data_preprocessing.pose.hrnet_utils import cut_frame_to_pose
...
def extract_faces_from_original_data(df_with_abs_paths:pd.DataFrame, output_path:str, labels_filename:str)->pd.DataFrame:
    ...
    detector = SimpleHigherHRNet(c=32, nof_joints=17, checkpoint_path="/work/home/dsu/simpleHigherHRNet/pose_higher_hrnet_w32_512.pth",
...
def main():
    ...
    output_path = '/media/external_hdd_2/Datasets/EMOTIC/cvpr_emotic/cvpr_emotic/preprocessed_pose/'
