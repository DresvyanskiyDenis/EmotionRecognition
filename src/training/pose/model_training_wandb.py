...
def train_model(train_generator: torch.utils.data.DataLoader, dev_generator: torch.utils.data.DataLoader,
    ...
    metaparams = {
        ...
        "dataset": "SEWA, AFEW-VA, EMOTIC, ExpW, RAF_DB",
    ...
    if config.MODEL_TYPE == "Modified_HRNet":
        model_layers = [# we do not take HRNet part, it should be always frozen (do not have enough data for fine-tuning)
